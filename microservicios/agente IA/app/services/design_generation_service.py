...
class DesignGenerationService:
    ...
    async def generate_design_image(
        ...
        try:
            ...
            enhanced_prompt = (
                "professional product photography, single garment, isolated product, "
                "no person, no model, no mannequin, "
                f"{prompt}, "
                "high quality, detailed, clean white background, studio lighting, "
                "commercial photography style, centered composition, front view, 8k"
            )
    ...
    async def should_generate_image(user_message: str) -> bool:
        ...
        keywords = [
            ...
            "camisa", "camiseta", "blusa", "pantalon", "pantalones", "ropa"
        ]
